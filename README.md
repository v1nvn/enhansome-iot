...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,026 | 🐛 68 | 📅 2026-04-19 [![Build Status](https://travis-ci.org/HQarroum/awesome-iot.svg?branch=master)](https://travis-ci.org/HQarroum/awesome-iot)
...
* [Home Assistant](https://github.com/home-assistant/home-assistant) ⭐ 86,241 | 🐛 3,785 | 🌐 Python | 📅 2026-04-26 - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
...
* [Huginn](https://github.com/cantino/huginn) ⭐ 49,184 | 🐛 697 | 🌐 Ruby | 📅 2026-04-25 - Huginn is a system for building agents that perform automated tasks for you online.
* [VerneMQ](https://github.com/erlio/vernemq) ⭐ 3,570 | 🐛 178 | 🌐 Erlang | 📅 2026-04-24 - VerneMQ is a high-performance, distributed MQTT broker that connects IoT, M2M, Mobile, and web applications. It scales horizontally and vertically on commodity hardware to support a high number of concurrent publishers and consumers while maintaining low latency and fault tolerance.
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,481 | 🐛 67 | 🌐 C | 📅 2026-04-21 - A lightweight and Blazing-fast MQTT Broker for IoT Edge platform.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,699 | 🐛 43 | 🌐 Go | 📅 2026-04-24 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run on all kinds of resource-constrained edge devices.
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,297 | 🐛 5 | 🌐 C# | 📅 2026-04-23 - IoTSharp is an open-source IoT platform for data collection, processing, visualization, and device management.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 687 | 🐛 207 | 🌐 Java | 📅 2026-04-26 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,892 | 🐛 825 | 🌐 Java | 📅 2026-04-26 - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 60 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-24 - Cross-platform Node.js CLI that reads BLE smart scales (23 brands), calculates body composition, and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. Runs on Raspberry Pi, Linux, macOS, and Windows.

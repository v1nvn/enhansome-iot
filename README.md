...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,426 | 🐛 73 | 📅 2026-05-05 [![Build Status](https://travis-ci.org/HQarroum/awesome-iot.svg?branch=master)](https://travis-ci.org/HQarroum/awesome-iot)

> A curated list of awesome Internet of Things projects and resources.

Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 465,426 | 🐛 73 | 📅 2026-05-05 list thing.
...
* [Home Assistant](https://github.com/home-assistant/home-assistant) ⭐ 87,019 | 🐛 3,922 | 🌐 Python | 📅 2026-05-12 - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
* [Countly IoT Analytics](http://github.com/countly/countly-server) ⭐ 5,858 | 🐛 13 | 🌐 JavaScript | 📅 2026-05-11 - Countly is a general purpose analytics platform for mobile and IoT devices, available as open source.
...
* [Huginn](https://github.com/cantino/huginn) ⭐ 49,262 | 🐛 695 | 🌐 Ruby | 📅 2026-05-09 - Huginn is a system for building agents that perform automated tasks for you online.
...
* [Kuzzle](https://github.com/kuzzleio/kuzzle) ⭐ 1,642 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-11 - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. ([Website](https://kuzzle.io/solutions/technologies/iot-backend/))
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,319 | 🐛 5 | 🌐 C# | 📅 2026-05-09 - IoTSharp is an open-source IoT platform for data collection, processing, visualization, and device management.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 688 | 🐛 206 | 🌐 Java | 📅 2026-05-12 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,936 | 🐛 825 | 🌐 Java | 📅 2026-05-12 - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
...
* [United Manufacturing Hub](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 367 | 🐛 10 | 🌐 Go | 📅 2026-05-11 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example, Nodered, VerneMQ and timescaleDB)

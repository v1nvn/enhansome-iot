...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,769 | 🐛 73 | 📅 2026-05-05 [![Build Status](https://travis-ci.org/HQarroum/awesome-iot.svg?branch=master)](https://travis-ci.org/HQarroum/awesome-iot)
...
* [Home Assistant](https://github.com/home-assistant/home-assistant) ⭐ 87,031 | 🐛 3,945 | 🌐 Python | 📅 2026-05-13 - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
* [Countly IoT Analytics](http://github.com/countly/countly-server) ⭐ 5,858 | 🐛 17 | 🌐 JavaScript | 📅 2026-05-13 - Countly is a general purpose analytics platform for mobile and IoT devices, available as open source.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-09 - A Homebridge plugin for integrating Blink cameras, doorbells, and sirens with Apple HomeKit, featuring live streaming, arm/disarm, and motion detection.
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-11 - A Homebridge plugin for integrating SmartRent locks, thermostats, leak sensors, and switches with Apple HomeKit via real-time WebSocket connection.
...
* [Huginn](https://github.com/cantino/huginn) ⭐ 49,266 | 🐛 696 | 🌐 Ruby | 📅 2026-05-09 - Huginn is a system for building agents that perform automated tasks for you online.
* [VerneMQ](https://github.com/erlio/vernemq) ⭐ 3,579 | 🐛 177 | 🌐 Erlang | 📅 2026-05-06 - VerneMQ is a high-performance, distributed MQTT broker that connects IoT, M2M, Mobile, and web applications. It scales horizontally and vertically on commodity hardware to support a high number of concurrent publishers and consumers while maintaining low latency and fault tolerance.
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,494 | 🐛 67 | 🌐 C | 📅 2026-05-12 - A lightweight and Blazing-fast MQTT Broker for IoT Edge platform.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,701 | 🐛 45 | 🌐 Go | 📅 2026-05-13 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run on all kinds of resource-constrained edge devices.
* [Kuzzle](https://github.com/kuzzleio/kuzzle) ⭐ 1,642 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-12 - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. ([Website](https://kuzzle.io/solutions/technologies/iot-backend/))
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 688 | 🐛 206 | 🌐 Java | 📅 2026-05-13 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,936 | 🐛 829 | 🌐 Java | 📅 2026-05-13 - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
...
* [United Manufacturing Hub](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 367 | 🐛 12 | 🌐 Go | 📅 2026-05-12 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example, Nodered, VerneMQ and timescaleDB)
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 68 | 🐛 12 | 🌐 TypeScript | 📅 2026-05-12 - Cross-platform Node.js CLI that reads BLE smart scales (23 brands), calculates body composition, and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. Runs on Raspberry Pi, Linux, macOS, and Windows.

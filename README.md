...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 457,719 | 🐛 65 | 📅 2026-04-19 [![Build Status](https://travis-ci.org/HQarroum/awesome-iot.svg?branch=master)](https://travis-ci.org/HQarroum/awesome-iot)

> A curated list of awesome Internet of Things projects and resources.

Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 457,719 | 🐛 65 | 📅 2026-04-19 list thing.
...
* [Home Assistant](https://github.com/home-assistant/home-assistant) ⭐ 86,150 | 🐛 3,620 | 🌐 Python | 📅 2026-04-22 - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
* [Countly IoT Analytics](http://github.com/countly/countly-server) ⭐ 5,850 | 🐛 29 | 🌐 JavaScript | 📅 2026-04-22 - Countly is a general purpose analytics platform for mobile and IoT devices, available as open source.
...
* [Huginn](https://github.com/cantino/huginn) ⭐ 49,155 | 🐛 695 | 🌐 Ruby | 📅 2026-04-19 - Huginn is a system for building agents that perform automated tasks for you online.
* [VerneMQ](https://github.com/erlio/vernemq) ⭐ 3,565 | 🐛 178 | 🌐 Erlang | 📅 2026-04-21 - VerneMQ is a high-performance, distributed MQTT broker that connects IoT, M2M, Mobile, and web applications. It scales horizontally and vertically on commodity hardware to support a high number of concurrent publishers and consumers while maintaining low latency and fault tolerance.
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,479 | 🐛 65 | 🌐 C | 📅 2026-04-21 - A lightweight and Blazing-fast MQTT Broker for IoT Edge platform.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,697 | 🐛 44 | 🌐 Go | 📅 2026-04-20 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run on all kinds of resource-constrained edge devices.
* [Kuzzle](https://github.com/kuzzleio/kuzzle) ⭐ 1,642 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-21 - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. ([Website](https://kuzzle.io/solutions/technologies/iot-backend/))
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 685 | 🐛 210 | 🌐 Java | 📅 2026-04-22 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,880 | 🐛 832 | 🌐 Java | 📅 2026-04-22 - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
...
* [United Manufacturing Hub](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 360 | 🐛 9 | 🌐 Go | 📅 2026-04-21 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example, Nodered, VerneMQ and timescaleDB)
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 55 | 🐛 9 | 🌐 TypeScript | 📅 2026-04-21 - Cross-platform Node.js CLI that reads BLE smart scales (23 brands), calculates body composition, and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. Runs on Raspberry Pi, Linux, macOS, and Windows.

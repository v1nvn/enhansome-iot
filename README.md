...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 471,887 | 🐛 83 | 📅 2026-05-05 [![Build Status](https://travis-ci.org/HQarroum/awesome-iot.svg?branch=master)](https://travis-ci.org/HQarroum/awesome-iot)

> A curated list of awesome Internet of Things projects and resources.

Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 471,887 | 🐛 83 | 📅 2026-05-05 list thing.
...
* [Home Assistant](https://github.com/home-assistant/home-assistant) ⭐ 87,439 | 🐛 4,094 | 🌐 Python | 📅 2026-06-01 - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
* [Countly IoT Analytics](http://github.com/countly/countly-server) ⭐ 5,868 | 🐛 18 | 🌐 JavaScript | 📅 2026-06-01 - Countly is a general purpose analytics platform for mobile and IoT devices, available as open source.
* [Thingsboard IoT Gateway](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,136 | 🐛 82 | 🌐 Python | 📅 2026-05-19 - Open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 37 | 🐛 143 | 🌐 Python | 📅 2026-05-30 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-29 - A Homebridge plugin for integrating SmartRent locks, thermostats, leak sensors, and switches with Apple HomeKit via real-time WebSocket connection.
...
* [Huginn](https://github.com/cantino/huginn) ⭐ 49,382 | 🐛 699 | 🌐 Ruby | 📅 2026-05-30 - Huginn is a system for building agents that perform automated tasks for you online.
...
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,518 | 🐛 68 | 🌐 C | 📅 2026-05-29 - A lightweight and Blazing-fast MQTT Broker for IoT Edge platform.
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,338 | 🐛 5 | 🌐 C# | 📅 2026-05-31 - IoTSharp is an open-source IoT platform for data collection, processing, visualization, and device management.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 17,014 | 🐛 849 | 🌐 Java | 📅 2026-06-01 - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
...
* [United Manufacturing Hub](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 368 | 🐛 13 | 🌐 Go | 📅 2026-05-31 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example, Nodered, VerneMQ and timescaleDB)
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 103 | 🐛 16 | 🌐 TypeScript | 📅 2026-05-21 - Cross-platform Node.js CLI that reads BLE smart scales (23 brands), calculates body composition, and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. Runs on Raspberry Pi, Linux, macOS, and Windows.
...
* [aem-modbus-simulator](https://github.com/leaberg69/aem-modbus-simulator) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-05-31 - Open-source Python Modbus RTU/TCP slave simulator emulating the LRI AEM-60DC8 industrial DC monitor. Mirrors 147 holding registers, 8 DC channels, six baudrates (4,800-115,200). Useful for SCADA/PLC integration testing without physical hardware.
...
* [BirdNET-Go](https://github.com/tphakala/birdnet-go) ⭐ 1,216 | 🐛 128 | 🌐 Go | 📅 2026-06-01 - Realtime wildlife soundscape analyser with multi-model AI inference, MQTT publishing with Home Assistant discovery, and web dashboard.
...
#### <img width="50" src="https://www.pjon.org/assets/images/PJON-logo-devices.jpg" /> - [PJON](https://github.com/gioblu/PJON/) ⭐ 2,803 | 🐛 60 | 🌐 C++ | 📅 2025-11-21
